    ...
    return (
      <div
        ...
        className={cn(
          ...
          {
            'border-transparent bg-bg-tertiary text-text-primary': variant === 'default',
            ...
            'border-transparent bg-red-500/10 text-red-600 dark:text-red-400': variant === 'danger',
            'border-transparent bg-blue-500/10 text-blue-600 dark:text-blue-400': variant === 'info',
          },
          className
        )}
        {...props}
